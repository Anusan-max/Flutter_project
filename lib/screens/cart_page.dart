...
class _CartPageState extends State<CartPage> {
  ...
  String displayTotal = "Show Total";
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
            onPressed: () {
              ...
              _showMaterialDialog(displayTotal);
              // Add your onPressed code here!
            },
            label: Text("Show total")
        )
    );
  }

  _showMaterialDialog(String total) {
    showDialog(
        context: context,
        builder: (_) => new AlertDialog(
          title: new Text("Do you want to complete the payment ? "),
          content: new Text("Total is " + total),
          actions: <Widget>[
            FlatButton(
              child: Text('Buy'),
              onPressed: () async {
  ...
  _deleteCart() async {
    ...
    var docref = _firebaseServices.usersRef
        .doc(_firebaseServices.getUserId()).collection("Cart");

    var cartlist  = docref.get();

    cartlist.then((value) => value.docs.forEach((element) {
      docref.doc(element.id).delete();
    }));
