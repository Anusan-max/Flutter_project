...
import 'package:flutter_project/widgets/image_swipe.dart';
import 'package:flutter_project/widgets/product_size.dart';
                          ...
                          Container(
                            ...
                            child: GestureDetector(
                                onTap: ()  {
                                  ...
                                  Share.share(
                                    "${documentData["name"]}" +" -  "+  "Rs ${documentData["price"]}",
