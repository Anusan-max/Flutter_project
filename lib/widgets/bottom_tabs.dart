          ...
          children: [
            ...
            BottomTabBtn(
              ...
              onPressed: () {
                ...
                Navigator.of(context).pushNamed(LandingPage.routerName);
              },
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            border: Border(
                top: BorderSide(
                  color:_seleted ? Theme.of(context).accentColor: Colors.transparent,
                  width: 2.0,
                )
            )
        ),
        child: Image(
          ...
          width: 22.0,
          height: 22.0,
          color: _seleted ? Theme.of(context).accentColor: Colors.black,
        ),
      ),
    );
  }
